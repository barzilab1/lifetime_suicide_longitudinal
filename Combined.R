...
# x_total = merge(Y_bucket, combined_bucket_lasso_nosui_amelia)
...
#original data set
x = merge(Y_bucket, combined_bucket_lasso_selected_amelia)
mini_bucket = combined_bucket_lasso_selected_amelia[,-1]
...
set.seed(42)
mod_raw <- glm(Lifetime_Suicide_Attempt~as.matrix(mini_bucket),data=x,family="binomial",maxit = 100)
summary(mod_raw)
